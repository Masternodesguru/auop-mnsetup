...
COIN_TGZP='https://github.com/masternodeguru/auop-mnsetup/releases/download/2004/opalcoin-daemon-linux.zip'
COIN_BOOTSTRAP=''
...
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/opalcoininfo/d' > /root/tmp
